;; 有两处修改：1，窗口编号从3开始。2，取消了部分M-n键的绑定。
;; 具体改动可在文件中搜索change 1/change 2
...
;;    (define-key map "\M-0" 'select-window-0) ;;change 2: comment out some binding
