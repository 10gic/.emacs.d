...
;; 把Ripgrep改为:Ripgrep是一个Workaround:
;; 输出中"Ripgrep started at ......"，会误匹配为文件名，把mode名字改为:Ripgrep
;; 会输出":Ripgrep started at ......"，这样不会误匹配为文件名了
...
;; (define-compilation-mode ripgrep-search-mode "Ripgrep"
  ...
  (add-hook 'compilation-mode-hook 'wgrep-remove-all-change nil t))
